...
#This analyze.py file is for analyzing the music files and storing the fingerprints in the database.\

# I have saved three audio and these are my test music file.
